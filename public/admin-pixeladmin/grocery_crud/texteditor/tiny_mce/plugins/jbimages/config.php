...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/assets/uploads/Articles'; // Relative to domain name
	$config['upload_path'] = /*base_url($config['img_path']);*/$_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
